...
/**
 * Servlet implementation class GetByIdCollege
 */
@WebServlet("/GetByIdCollege")
public class GetByIdCollege extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetByIdCollege() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			College college = cDAO.getCollegeById(contact_email);
			request.setAttribute("User_Details", college);
